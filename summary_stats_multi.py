...
# now trying median
DADI_PARAMS = [420699, 89497, 9449179, 2243, 18328570, 39242967, 42056997, 42050613]
...
# now trying median
DADI_MIG_PARAMS = [415254, 91234, 9164256, 2996, 22149704, 11679596, 31103040, 19166216, 20]
